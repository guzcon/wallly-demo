...
<!--   <div class="wally_container_header row <?php echo isset($_GET['wallly_hide_header']) ? 'hidden' : ''; ?>">
    <h1 class="col-xs-12"><img class="ict-logo" src="<?php echo get_template_directory_uri() . '/assets/images/ICT-musta-oranssi_04.png'; ?>"> <b class="pull-right">#ICTexpoHKI</b></h1>
  </div> -->
